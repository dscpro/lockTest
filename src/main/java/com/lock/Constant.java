...
public final class Constant {
	 ...
	 * 线程数
	 */
	public static Integer[] NUM_THREADS = {5,50,80,100,200,500,800,1000,1200,1400,1600,1800,2000,2200,2400,2600,2800,3000,3200,3500,3800,4000,4200,4500,4800,5000,5200,5500,5800,6000,7000,8000};
	/**
	 * 读操作线程数
	 */
