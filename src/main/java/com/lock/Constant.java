...
public final class Constant {
	 ...
	 * 线程数
	 */
	public static Integer[] NUM_THREADS = {5,50,80,100,200,500,800,1000,1200,1500,1800,2400,2800,3000,3300,3500,3800,4000,4200,4500,4700,5000,6000,7000,8000,10000};
	/**
	 * 读操作线程数
	 */
	public static Integer[] NUM_READ ={0,1,5,50,100,1000,2000,3000,4000,5000,6000,7000,8000,9000,10000};
	/**
	 * 执行次数
	 */
